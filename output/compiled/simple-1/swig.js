...
(function () {
  ...
  if (!__l) { return; }
    var _ctx__loopcache05736044884348441 = { loop: _ctx.loop, color: _ctx.color, __k: _ctx.__k };
...
_output += "</li>\n            ";
  ...
  _ctx.loop = _ctx__loopcache05736044884348441.loop;
  _ctx.color = _ctx__loopcache05736044884348441.color;
  _ctx.__k = _ctx__loopcache05736044884348441.__k;
  _ctx__loopcache05736044884348441 = undefined;
})();
_output += "\n        </ul>\n        ";
} else {
_output += "\n        <div>\n            No colors!\n        </div>\n        ";
